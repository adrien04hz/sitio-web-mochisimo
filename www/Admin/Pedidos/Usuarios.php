...
while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {  
    ...
    $queryProd = "
        ...
        WHERE
            ...
            AND detalles.id_prod = Producto.id 
            AND Producto.id = prod_img.id_prod 
            AND prod_img.id_img = Imagenes.id;
    ";
    ...
    if ($productosPedido) {
        ...
        $respuestaUser .= "<input type='hidden' name='id_estado' value='" . htmlspecialchars($row['id']) . "'>";
